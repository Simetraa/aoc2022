...
for line in instructions_data:
    ...
    # extract last count elements, delete from start and extend to dest
    popped = dict_stacks[start][-count:]
    del dict_stacks[start][-count:]
    dict_stacks[dest].extend(popped)
